...
FOR %%x IN ("E:\Development\Bearsampp\bin\php\php7.4.30\pear\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=E:\Development\Bearsampp\bin\php\php7.4.30\pear\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=E:\Development\Bearsampp\bin\php\php7.4.30\pear"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=E:\Development\Bearsampp\bin\php\php7.4.30\php.exe"
GOTO :INSTALLED
