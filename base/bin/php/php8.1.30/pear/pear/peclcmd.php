...
if ('E:\Bearsampp-development\sandbox\bin\php\php8.1.30\pear\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('E:\Bearsampp-development\sandbox\bin\php\php8.1.30\pear\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
