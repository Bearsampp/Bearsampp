...
if ('~BEARSAMPP_WIN_PATH~\bin\php\php8.0.27\pear\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('~BEARSAMPP_WIN_PATH~\bin\php\php8.0.27\pear\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
