...
FOR %%x IN ("E:\Development\MY_PROJECTS\bearsampp-development\Bearsampp\bin\tmp\release\Bearsampp-2022.10.01\bin\php\php8.0.23\pear\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=E:\Development\MY_PROJECTS\bearsampp-development\Bearsampp\bin\tmp\release\Bearsampp-2022.10.01\bin\php\php8.0.23\pear\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=E:\Development\MY_PROJECTS\bearsampp-development\Bearsampp\bin\tmp\release\Bearsampp-2022.10.01\bin\php\php8.0.23\pear"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=E:\Development\MY_PROJECTS\bearsampp-development\Bearsampp\bin\tmp\release\Bearsampp-2022.10.01\bin\php\php8.0.23\php.exe"
GOTO :INSTALLED
