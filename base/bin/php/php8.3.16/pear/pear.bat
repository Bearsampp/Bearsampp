...
FOR %%x IN ("E:\Bearsampp-development\sandbox\bin\php\php8.3.16\pear\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=E:\Bearsampp-development\sandbox\bin\php\php8.3.16\pear\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=E:\Bearsampp-development\sandbox\bin\php\php8.3.16\pear"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=E:\Bearsampp-development\sandbox\bin\php\php8.3.16\php.exe"
