...
if ('E:\Bearsampp-development\sandbox\bin\php\php8.3.16\pear\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('E:\Bearsampp-development\sandbox\bin\php\php8.3.16\pear\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
