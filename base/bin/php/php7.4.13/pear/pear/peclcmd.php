...
if ('~BEARSAMPP_WIN_PATH~\bin\php\php7.4.13\pear\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('~BEARSAMPP_WIN_PATH~\bin\php\php7.4.13\pear\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
