...
if ('E:\Bearsampp-development\sandbox\bin\php\php8.2.27\pear\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('E:\Bearsampp-development\sandbox\bin\php\php8.2.27\pear\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
