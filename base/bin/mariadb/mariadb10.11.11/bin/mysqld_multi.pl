...
$opt_mysqld        = "C:/Program Files/MySQL/bin/mariadbd";
$opt_no_log        = 0;
$opt_password      = undef();
$opt_tcp_ip        = 0;
$opt_user          = "root";
...
#### order:  my_print_defaults mysqld datadir, C:/Program Files/MariaDB 10.11/data
####
...
sub init_log
{
  ...
  if (!defined($logdir))
  {
    $logdir= "C:/Program Files/MariaDB 10.11/data" if (-d "C:/Program Files/MariaDB 10.11/data" && -w "C:/Program Files/MariaDB 10.11/data");
  }
  if (!defined($logdir))
  {
...
port       = 3307
pid-file   = C:/Program Files/MariaDB 10.11/data2/hostname.pid2
datadir    = C:/Program Files/MariaDB 10.11/data2
...
port       = 3308
pid-file   = C:/Program Files/MariaDB 10.11/data3/hostname.pid3
datadir    = C:/Program Files/MariaDB 10.11/data3
...
port       = 3309
pid-file   = C:/Program Files/MariaDB 10.11/data4/hostname.pid4
datadir    = C:/Program Files/MariaDB 10.11/data4
...
port       = 3311
pid-file   = C:/Program Files/MariaDB 10.11/data6/hostname.pid6
datadir    = C:/Program Files/MariaDB 10.11/data6
