...
| ![Tool](https://img.shields.io/badge/Tool-%23468847?style=flat-square&color=%23468847)               | [ConsoleZ](https://bearsampp.com/module/cmder): modified version of Console 2 for a better experience.                                        |
...
Bearsampp uses Gradle as its build system. For detailed build instructions, see:
...
```bash
# Build all release variants (full, basic, lite)
gradle release
