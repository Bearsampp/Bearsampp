...
_tabversion   = '3.10'
_lextokens    = set(('CHAR_CONST', 'CONDOP', 'RBRACE', 'SEMI', 'EXTERN', 'NOT', 'GT', 'ANDEQUAL', 'SIZEOF', 'EQUALS', 'EQ', 'INT_CONST_CHAR', 'LBRACE', 'U16STRING_LITERAL', 'IF', 'RSHIFTEQUAL', 'U16CHAR_CONST', 'GE', 'SIGNED', 'U32STRING_LITERAL', 'UNION', 'OREQUAL', 'NE', 'TYPEID', 'RPAREN', 'MINUSEQUAL', 'RETURN', 'PLUSPLUS', 'MINUSMINUS', 'LONG', 'U8STRING_LITERAL', 'SHORT', 'BREAK', 'VOID', 'TIMESEQUAL', 'MOD', 'ID', 'WHILE', 'UNSIGNED', 'OFFSETOF', 'PLUSEQUAL', 'PPPRAGMA', 'LPAREN', 'LOR', 'U8CHAR_CONST', 'INT_CONST_OCT', 'AND', 'XOREQUAL', 'HEX_FLOAT_CONST', 'INT_CONST_DEC', 'COLON', 'FLOAT_CONST', 'LE', 'RESTRICT', 'COMMA', 'OR', 'RSHIFT', 'ENUM', 'INT', 'INT_CONST_HEX', 'WSTRING_LITERAL', 'LSHIFT', 'STRING_LITERAL', 'LSHIFTEQUAL', 'LAND', 'PPPRAGMASTR', '_THREAD_LOCAL', '_ALIGNOF', 'CASE', 'LBRACKET', 'DOUBLE', 'PERIOD', 'ELSE', 'DIVIDE', 'TYPEDEF', 'TIMES', 'STATIC', '_BOOL', '_COMPLEX', '_ATOMIC', 'LNOT', 'LT', '_ALIGNAS', 'DEFAULT', 'INLINE', 'ARROW', 'VOLATILE', 'FLOAT', 'CONTINUE', '__INT128', 'FOR', 'XOR', 'DIVEQUAL', 'STRUCT', 'PLUS', 'REGISTER', 'GOTO', 'MODEQUAL', 'PPHASH', 'DO', 'AUTO', 'CONST', 'SWITCH', 'CHAR', 'ELLIPSIS', '_NORETURN', 'MINUS', 'U32CHAR_CONST', '_STATIC_ASSERT', 'INT_CONST_BIN', 'RBRACKET', 'WCHAR_CONST'))
_lexreflags   = 64
_lexliterals  = ''
