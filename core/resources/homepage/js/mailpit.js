...
/**
 * @fileoverview Mailpit service status display for the Bearsampp homepage.
 * Sets up a StatusFetcher to keep the Mailpit check port and version list up to date.
 */
