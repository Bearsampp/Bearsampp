...
/**
 * @fileoverview Xlight service status display for the Bearsampp homepage.
 * Sets up a StatusFetcher to keep the Xlight check port and version list up to date.
 */
