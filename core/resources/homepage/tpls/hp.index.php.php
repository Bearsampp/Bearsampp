  ...
  <div class="col-lg-6">
    <div class="list-group">
      ...
      <span class="list-group-item">
        <i class="fa fa-info-circle"></i> <a href="<?php echo $bearsamppHomepage->getPageQuery(Homepage::PAGE_PHPINFO); ?>"><?php echo $bearsamppLang->getValue(Lang::HOMEPAGE_PHPINFO_TEXT); ?></a>
      </span>
      <?php if (function_exists('apc_add') && function_exists('apc_exists')) {
    ?>
      <span class="list-group-item">
        <i class="fa fa-info-circle"></i> <a href="<?php echo $bearsamppHomepage->getPageQuery(Homepage::PAGE_STDL_APC); ?>" target="_blank"><?php echo $bearsamppLang->getValue(Lang::HOMEPAGE_APC_TEXT); ?></a>
      </span>
      <?php
} ?>
    </div>
