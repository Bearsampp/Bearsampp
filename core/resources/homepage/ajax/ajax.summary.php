...
$result['binapache'] .= '<span class="span-right float-endbadge' . $apacheLabel . '">' . $bearsamppBins->getApache()->getVersion() . '</span>';
...
$result['binfilezilla'] .= '<span class="span-right float-endbadge' . $filezillaLabel . '">' . $bearsamppBins->getFilezilla()->getVersion() . '</span>';
...
$result['binmailhog'] .= '<span class="span-right float-endbadge' . $mailhogLabel . '">' . $bearsamppBins->getMailhog()->getVersion() . '</span>';
...
$result['binmariadb'] .= '<span class="span-right float-endbadge' . $mariadbLabel . '">' . $bearsamppBins->getMariadb()->getVersion() . '</span>';
...
$result['binmysql'] .= '<span class="span-right float-endbadge' . $mysqlLabel . '">' . $bearsamppBins->getMysql()->getVersion() . '</span>';
...
$result['binpostgresql'] .= '<span class="span-right float-endbadge' . $postgresqlLabel . '">' . $bearsamppBins->getPostgresql()->getVersion() . '</span>';
...
$result['binmemcached'] .= '<span class="span-right float-endbadge' . $memcachedLabel . '">' . $bearsamppBins->getMemcached()->getVersion() . '</span>';
...
$result['binnodejs'] .= '<span class="span-right float-endbadge' . $nodejsLabel .'">' . $bearsamppBins->getNodejs()->getVersion() . '</span>';
...
$result['binphp'] .= '<span class="span-right float-endbadge' . $phpLabel .'">' . $bearsamppBins->getPhp()->getVersion() . '</span>';
