...
class Root
{
    ...
    public function register()
    {
        ...
        require_once $this->path . '/classes/class.path.php';
        ...
        CacheManager::init($this->path . '/tmp/cache');
    ...
    {
        error_reporting(-1);
        ini_set('error_log', $this->path . '/logs/bearsampp-error.log');
    ...
    public function errorHandler($errno, $errstr, $errfile, $errline)
    {
        ...
        file_put_contents($this->path . '/logs/bearsampp-error.log', $content, FILE_APPEND);
    }
