...
* **required** : Replace your existing PHP version with the latest [PHP release](https://bearsampp.github.io/modules/php/#releases).
...
* **required** : Replace your existing Apache version with the latest [Apache release](https://bearsampp.github.io/modules/apache/#releases).
* **required** : Replace your existing Filezilla version with the latest [Filezilla release](https://bearsampp.github.io/modules/filezilla/#releases).
